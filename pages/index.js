  ...
  return (
    <section className='flex flex-1'>
      <div className='container mx-auto'>
        <div className='flex h-full flex-col items-center justify-center gap-y-5 md:gap-y-10 xl:justify-start xl:pt-20'>
          <Image src='/img/next-auth.png' width={255} height={284} alt='Logo' />
